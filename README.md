...
<br />
<div align="center">
  <a href="https://github.com/lumen-oss/lux.nvim">
  ...
  <p align="center">
    ...
    <br />
    <br />
    <a href="https://github.com/lumen-oss/lux.nvim/issues/new?assignees=&labels=bug">Report Bug</a>
    ·
    <a href="https://github.com/lumen-oss/lux.nvim/issues/new?assignees=&labels=enhancement">Request Feature</a>
    ·
    <a href="https://github.com/lumen-oss/lux.nvim/discussions/new?category=q-a">Ask Question</a>
  </p>
  <p>
    <strong>
...
- Extensible, with a Lua API.
  - [`lux-config.nvim`](https://github.com/lumen-oss/lux-config.nvim)
    for plugin configuration.
  - [`lux-lazy.nvim`](https://github.com/lumen-oss/lux-lazy.nvim)
    for lazy-loading.
  - [`lux-treesitter.nvim`](https://github.com/lumen-oss/lux-treesitter.nvim)
...
- Binary packages pulled from [lux-binaries](https://lumen-oss.github.io/lux-binaries/)
  so you don't have to compile them.

![demo](https://github.com/lumen-oss/lux.nvim/assets/12857160/ce678546-76a7-4fdc-b822-e43d51652681)
...
We have a detailed article explaining why we chose a different approach [here](https://github.com/lumen-oss/lux.nvim/wiki/What-about-packspec-(pkg.json)%3F).
...
additional configuration capabilities: [`lux-config.nvim`](https://github.com/lumen-oss/lux-config.nvim).
...
Additionally, [`lux-git.nvim`](https://github.com/lumen-oss/lux-git.nvim)
...
When installing, lux.nvim will also search our [lux-binaries (dev)](https://lumen-oss.github.io/lux-binaries-dev/)
...
Or, you can use our [`lux-treesitter.nvim`](https://github.com/lumen-oss/lux-treesitter.nvim)
...
<!-- check out our [`lux-treesiter.nvim` module](https://github.com/lumen-oss/lux-treesitter.nvim). -->
...
```sh
nvim -u NORC -c "source https://raw.githubusercontent.com/lumen-oss/lux.nvim/master/installer.lua"
```
...
For manual installation, see [this tutorial](https://github.com/lumen-oss/lux.nvim/wiki/Installing-lux.nvim-manually,-without-the-installation-script).
...
- [`lux-git.nvim`](https://github.com/lumen-oss/lux-git.nvim):
...
- [`lux-dev.nvim`](https://github.com/lumen-oss/lux-dev.nvim):
